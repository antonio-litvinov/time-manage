...
namespace Classes
{
    ...
    public class TAddView : TChange
    {
        public TView View;

        public TAddView() { }
        public TAddView(TView View) { this.View = View; }
    }
    ...
    public class TAddTaskDocument : TChange
    {
        public TTaskDocument TaskDocument;

        public TAddTaskDocument() { }
        public TAddTaskDocument(TTaskDocument TaskDocument) { this.TaskDocument = TaskDocument; }
    }
    ...
    public class TAddChangeItem : TChange
    {
        public TChangeItem ChangeItem;

        public TAddChangeItem() { }
        public TAddChangeItem(TChangeItem ChangeItem) { this.ChangeItem = ChangeItem; }
    }

    public class TDeleteView : TChange
    {
        public Guid ViewID;

        public TDeleteView() { }
        public TDeleteView(Guid ViewID) { this.ViewID = ViewID; }
    }
    ...
    public class TDeleteTaskDocument : TChange
    {
        public Guid TaskID;

        public TDeleteTaskDocument() { }
        public TDeleteTaskDocument(Guid TaskID) { this.TaskID = TaskID; }
    }
    ...
    public class TEditView : TChange
    {
        public TView View;

        public TEditView() { }
        public TEditView(TView View) { this.View = View; }
    }
